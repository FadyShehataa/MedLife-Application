...
class VerificationCodePharmacist extends StatelessWidget {
  VerificationCodePharmacist({Key? key, required this.verificationToken})
      : super(key: key);
    ...
    return BlocConsumer<AuthCubit, AuthState>(
      listener: (context, state) async {
        if (state is VerificationLoading) {
          ...
          showSnackBar(
              context,
              "Verified Successfully But License Not Validated Yet!",
              Colors.green);
